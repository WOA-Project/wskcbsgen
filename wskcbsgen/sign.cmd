...
REM if "%SIGN_WITH_TIMESTAMP%"=="1" set TIMESERVER=/t http://timestamp.verisign.com/scripts/timestamp.dll
if "%SIGN_WITH_TIMESTAMP%"=="1" set TIMESERVER=/t http://timestamp.globalsign.com/scripts/timstamp.dll
...
REM if "%GENERATE_SIGNINFO_FILES%"=="1" (
REM     goto :SIGNER_SIGNING
REM ) else (
...
if "%CERTIFICATEFLAG%"=="pkg" set SCENARIO_NAME=MicrosoftCorporation
